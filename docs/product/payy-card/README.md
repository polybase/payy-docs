...
| No credit check or fees to apply               | Applying only requires identity verification. No credit history is pulled.                                                                        |
...
* [Visa benefits](https://drive.google.com/file/d/1kyHWoeas2mv7kZ319zcKcat6Anxnv5mk/view?usp=sharing)
